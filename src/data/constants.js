...
export const projects = [
  ...
  },
  {
    ...
    description:
      "Developed a personal AI application using OpenAI API,React,Express and MonogoDB. Implemented private routing using JWT for enhanced security and authentication. These AI models can be used to generate human-like text, answer questions, translate languages, and more.",
    image:gptImg,
    tags: [
      "React Js",
      "MongoDB",
  ...
  {
    id: 3,
    title: "Automated Multiple Choice Questions Generation using NLP",
    date: "Aug 2023 - Dec 2023",
    description:
      "Conceptualized and developed an innovative educational tool that automates the generation of multiple-choice questions from video content, aiding in comprehensive topic revision.Implemented advanced natural language processing techniques, utilizing BERT for contextual language understanding and RAKE for keyword identification.",
    image:mcqImg,
    tags: [
      "Python",
      "NLP",
